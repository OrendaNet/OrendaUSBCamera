...
manifest.versions = [{
  ...
  releaseNotes: 'Live USB camera video through approved Edge access. Logitech C270 target; 640×480 at up to 10 fps. No recording or audio. Requires Edge Manager 0.2.39 or newer.'
}];
